...
const GridNews = () => {
    return (
        <div
            className="mx-2 my-2 p-2 text-dark d-flex row w-100 align-items-center justify-content-center"
            style={{ minHeight: "80vh" }}>
            <h2 className="px-5 m-0 my-1 fw-bold">Novedades</h2>

            <div
                className="col-12 p-4 col-lg-6 d-flex align-items-center justify-content-center"
            ...
            <div
                className="col-12 col-lg-6 row d-flex
